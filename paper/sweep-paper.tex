...
\hypersetup{
  pdftitle={Estimation of survey efficiency and abundance for commercially important species from industry-based paired gear experiments},
  pdfauthor={Timothy J. Miller1; David E. Richardson2; Philip J. Politis1; Christopher D. Roebuck3; John P. Manderson4,5; Michael H. Martin1,6; Andrew W. Jones2},
  hidelinks,
...
of survey catchability from auxiliary data can inform the stock
...
other side of the twin-trawl rig towed a version of the NEFSC 400 x 12cm
...
sensitive. Finally, we calculated the correlation of annual biomass
...
skate. For most of the species, the difference in efficiencies between
...
contact path moved into the path of the net path. The former is a
function of gear design, and controllable, whereas the latter is a
...
{\fontsize{10pt}{10pt}\selectfont\input{data_table}}
\end{table}
\end{landscape}
...
{\fontsize{7pt}{7pt}\selectfont\input{best_model_compare}}
\end{table}
\end{landscape}
