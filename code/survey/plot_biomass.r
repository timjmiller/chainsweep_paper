plot_biomass = function(i,sp.info, stock, file.loc = "~/work/paired_tow_studies/R/2020")# = rep(6,6))
{
...
#here!!!!
  ...
  y = read.csv(paste0(sp.name,"/2020_", stock, ".biomass.csv"))
  print(y)
  z = read.csv(paste0(sp.name,"/2020_", stock, ".cv.biomass.csv"))
  print(z)
  years = y[,1]
  #print(years)
